    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Customer Detail</h2></div>
                    <div class="col-sm-4">
            ...
            <table class="table table-bordered">
                ...
                <c:forEach var="customer" items="${customerListFromServlet}">
                    <tr>
                        ...
                        <td>
                            <a href="/customer?actionUser=update&id=${customer.customer_id}" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a onclick="setValue('${customer.customer_id}')" data-toggle="modal" data-target="#exampleModal" class="material-icons">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
<%--                <tr>--%>
